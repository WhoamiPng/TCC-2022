                    ...
                    <div class="container">
                        <div class="row h-150px align-items-center">
                            <div class="col-lg-6 pt-5">
                                ...
                                <p class="lead text-muted mb-0">Veja abaixo os motivos para fazer você usar nosso site.
                                </p>
                                ...
                                <div class="container ">
                                    <div class="row align-items-center mb-5">
                                        <div class="col-lg-6 order-2 order-lg-1"><i
                                            ...
                                            <p class="font-italic text-muted mb-4">Somos a 5Chan, site inspirado no
                                                4Chan,
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                                            ...
                                            <p class="font-italic text-muted mb-4">Respeitamos sua privacidade,
                                                guardamos
                                                seus dados, como senha e nome de usuário em nosso banco de dados seguro,
                                                nosso site contêm SSL, o que garante que seus dados estarão sempre
                                                criptografados, o que inibe que ataques hackers peguem seus dados que
                                                estarão com uma criptografia SHA-256.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row align-items-center mb-5">
                                        <div class="col-lg-6 order-2 order-lg-1"><i
                                            ...
                                            <p class="font-italic text-muted mb-4">Nosso site utiliza as tecnologias
                                                mais
                                                recentes e atualizadas, não utilizamos tecnologias desatualizadas como
                                                nosso
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                                            ...
                                            <p class="font-italic text-muted mb-4">Nossa equipe é uma das melhores no
                                                ramo
                                                de criação de Foruns.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-dark rounded shadow-sm py-5 px-4"><img src="imagens/stefani.jpg"
                                            alt="" width="150px"
                                ...
                                <div class="col-xl-3 col-sm-6 mb-5">
                                    <div class="bg-dark rounded shadow-sm py-5 px-4"><img src="imagens/gabriel.jpg"
                                            alt="" width="150px"
                                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
